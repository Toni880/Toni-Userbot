    ...
    if event.query.user_id == OWNER_ID:
        ...
        with io.BytesIO(str.encode(msg)) as fileuser:
            ...
            await tgbot.send_file(
                ...
                fileuser,
                force_document=True,
                thumb="userbot/resource/extras/Tonic.jpg",
    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**Users**: {mention}\
                        ...
                        \n**Forward**: True\
                        \n\n**Powered by**: [Tonic-Userbot](https://github.com/Tonic990/Tonic-Userbot)"
            buttons=[
                (
...
async def infor(event):
        await tgbot.send_message(
            event.chat_id,
            message=f"**Channel**: [Support Channel](t.me/PrimeSupportChannel)\n**Github**: [Tonic-Userbot](https://github.com/Tonic990/Tonic-Userbot)\n**Deploy**: [Heroku](https://telegram.dog/XTZ_HerokuBot?start=VG9uaWM5OTAvVG9uaWMtVXNlcmJvdCBUb25pYy1Vc2VyYm90)",
            buttons=[
                [
                    custom.Button.inline(
                        "ᴄʟᴏꜱᴇ",
