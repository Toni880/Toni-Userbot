...
@toni_cmd(pattern=r"delcostum (\w*)")
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `{cmd}costum` <nama> <data> atau membalas pesan dengan {cmd}costum <nama>\
