...
from telethon.tl.types import User
 ...
 userbot.modules.sql_helper.pm_permit_sql as pmpermit_sql
from userbot import CMD_HANDLER as cmd
from userbot import CMD_HELP, COUNT_PM, LASTMSG, LOGS, PM_AUTO_BAN, PM_LIMIT, bot
from userbot.events import toni_cmd, register
...
@bot.on(toni_cmd(outgoing=True, pattern=r"notifoff$"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"notifon$"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"(?:setuju|ok)\s?(.)?"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"(?:tolak|nopm)\s?(.)?"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"block$"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"unblock$"))
...
@bot.on(toni_cmd(outgoing=True, pattern=r"(set|get|reset) pmpermit(?: |$)(\w*)"))
