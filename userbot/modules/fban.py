...
async def fban(event):
    ...
    if event.sender_id == fban_id:
        return await event.edit(
            "**Error: This action has been prevented by ToniBot self preservation protocols.**"
        )
